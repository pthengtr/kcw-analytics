...
const TRANSACTION_DETAIL_COL_PATTERNS = [
  "รายละเอียด",
  "^DESCRIPTION$",
  "PARTICULAR",
  "NARRATION",
...
function extractTransactionDetailFromRaw(
...
function inferAccountFromFilename(
  filename: string,
...
const BANK_STATEMENT_SYNC_PAGE = "bank_statement_sync";
 ...
 */
async function requireBankStatementSyncPermission(
